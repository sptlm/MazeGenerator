...
/**
 * Генератор лабиринтов методом поиска в глубину (Depth-First Search). Алгоритм создает идеальный лабиринт (без циклов)
 * с единственным путем между любыми двумя точками.
 *
 * <p>Принцип работы: 1. Начинаем со случайной ячейки 2. Помечаем текущую ячейку как посещенную 3. Пока есть
 * непосещенные соседи: - Выбираем случайного непосещенного соседа - Удаляем стену между текущей ячейкой и соседом -
 * Рекурсивно повторяем для соседа 4. Когда зашли в тупик, возвращаемся назад
 */
