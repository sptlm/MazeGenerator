...
/**
 * Генератор лабиринтов методом алгоритма Прима.
 * Создает идеальный лабиринт путем постепенного добавления ячеек к растущему дереву.
 *
 * Принцип работы:
 * 1. Начинаем со случайной ячейки и добавляем ее в лабиринт
 * 2. Добавляем все соседние стены этой ячейки в список границ
 * 3. Пока список границ не пуст:
 *    - Выбираем случайную стену из списка
 *    - Если ячейка за стеной еще не в лабиринте:
 *      - Делаем эту стену проходом
 *      - Добавляем ячейку за стеной в лабиринт
 *      - Добавляем соседние стены новой ячейки в список границ
